...
public class TesteOrdenacao {
	...
	public static void main(String[] args) {
		...
		for (Conta conta : lista) {
			System.out.println("Nome do Titular: " + conta.getTitular().getNome() + ", " + conta);
		}

		// NumeroDaContaComparator comparadorNum = new NumeroDaContaComparator();
...
//		Collections.reverse(lista);
		...
		for (Conta conta : lista) {
			System.out.println("Nome do Titular: " + conta.getTitular().getNome() + ", " + conta + ", Saldo: " + conta.getSaldo());
		}
	}
}
